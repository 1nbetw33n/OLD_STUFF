...
public interface GroupIF {
	...
	/**
	 * 
	 * @TODO: coding, if necessary adaption of test cases
	 */
	 ...
	 * 
	 */
	void appendLast(final Dish D) throws TableSpaceOutOfBoundsException;
	 ...
	 */
	Dish removeLast() throws Exception;
	 ...
	 * 				   -object is null
	 */
	Dish get(final int POSITION) throws Exception;
