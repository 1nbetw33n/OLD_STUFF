...
public class HumanOfMiddleEarth extends Mortal{
	
	public HumanOfMiddleEarth(final String NAME, final int AGE) {
		super(NAME, AGE);
		this.setMaxLifeExpectancy(80);
	}
	
	public final String greeting() {return "Greetings!";}
	
	public void take(final Portable PORTABLE) throws PortableItemException {
		if (PORTABLE.weight() - 100. > 0.00000001) {
			throw new PortableItemException("Portable Item too heavy for a common Human");
		}else {
