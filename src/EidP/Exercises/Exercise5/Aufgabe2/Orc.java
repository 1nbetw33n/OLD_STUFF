...
public class Orc extends Mortal {
	...
	public final String greeting() {return "Ug!";}
	
	public void take(final Portable PORTABLE) throws PortableItemException {
		if (PORTABLE.weight() - 120. > 0.00000001) {
			throw new PortableItemException("Portable Item too heavy for an Orc");
		}else {
