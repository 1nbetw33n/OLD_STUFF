...
public class Hobbit extends Mortal {
	
	public Hobbit(final String NAME, final int AGE) {
		super(NAME, AGE);
		this.setMaxLifeExpectancy(150);
		this.setLifeExpectancy(this.getMaxLifeExpectancy());
	}

	public final String greeting() {return "Hello!";}
	
	public void take(final Portable PORTABLE) throws PortableItemException {
		if (PORTABLE.weight() - 20. > 0.00000001) {
			throw new PortableItemException("Portable Item too heavy for a Hobbit");
		}else {
