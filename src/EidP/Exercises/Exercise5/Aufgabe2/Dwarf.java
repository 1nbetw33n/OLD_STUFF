...
public class Dwarf extends Mortal {

	
	public Dwarf(final String NAME, final int AGE) {
		super(NAME, AGE);
		this.setMaxLifeExpectancy(300);
	}
	
	public final String greeting() {return "Gamut manan!";}
	
	public void take(final Portable PORTABLE) throws PortableItemException {
		if (PORTABLE.weight() - 200. > 0.00000001) {
			throw new PortableItemException("Portable Item too heavy for a Dwarf");
		}else {
